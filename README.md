...
O **Sistema de Gerenciamento de Cozinha** é uma plataforma robusta desenvolvida para simular e gerenciar o fluxo operacional de um restaurante/cozinha. O projeto destaca-se pela sua arquitetura híbrida:
